Select nome_CATEGORIA_CLIENTES as 'Categoria', nome_CLIENTES as 'Nome', sobrenome_CLIENTES as 'Sobrenome' , nome_produtos as 'Produto', data_PEDIDO as 'Data e Hora', valor_compra as 'Valor Total' from categoria_cliente
